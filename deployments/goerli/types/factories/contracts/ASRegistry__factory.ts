...
type ASRegistryConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: ASRegistryConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class ASRegistry__factory extends ContractFactory {
  constructor(...args: ASRegistryConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override attach(address: string): ASRegistry {
    return super.attach(address) as ASRegistry;
  }
  override connect(signer: Signer): ASRegistry__factory {
