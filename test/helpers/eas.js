...
//   async attestByDelegation(recipient, ao, expirationTime, refUUID, data, attester, privateKey, options = {}) {
//     let encodedData = data;
//     if (typeof data === 'string' && !data.startsWith('0x')) {
...
//     if (!isEmpty(options)) {
//       return this.contract.testAttestByDelegation(
//         EAS.getAddress(recipient),
//         ao,
//         expirationTime,
//         EAS.toBytes32(refUUID),
...
//   async revokeByDelegation(uuid, attester, privateKey, options = {}) {
//     const nonce = await this.eip712Verifier.getNonce(attester);
